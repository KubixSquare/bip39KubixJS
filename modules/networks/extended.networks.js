...
bitcoin.networks.crown = {
  ...
  toNewAddress: function(oldAddress)
  {
    ...
    var hash160 = buffer.Buffer.from(new Uint16Array(23));
    hash160[0]= 0x01; //C
    hash160[1]= 0x75; //R
    hash160[2]= 0x07; //W
    addrBytes.copy(hash160, 3, 1, 21);

    var checksum = bitcoin.crypto.hash256(hash160).subarray(0, 4);
    var binaryAddr = buffer.Buffer.from(new Uint16Array(27));
...
bitcoin.networks.blocknode_testnet = {
...
bitcoin.networks.monkeyproject = {
...
bitcoin.networks.sugarchaintestnet = {
    messagePrefix: '\x18Sugarchain Signed Message:\n',
    bip32: {
        public: 0x045f1cf6,
        private: 0x045f18bc,
...
// https://github.com/bitcoinjs-lib/blob/3f6f5ef97a1ee1b8337865209282c0095e22b2e7/src/networks.js
